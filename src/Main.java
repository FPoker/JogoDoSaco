...
//-------------------------------------------------------- MENU ------------------------------------------------------//
    ...
    private static void ConsultarCondicoesJogo() {
        ...
        System.out.println("No inicio de cada jogo o locutor anuncia o peso que pode variar entre 1 a 5kg.\n" +
                "Os participantes têm depois que dar palpipes acima do valor que o locutor anunciou, sendo que o palpite máximo\n" +
                "não pode exceder em mais de 150g o valor que o locutor anunciou. Por exemplo, se o locutor anuncia o peso de 2.5Kg\n" +
                "o valor máximo que os participantes podem apostar será de 2.65kg.\n" +
                "O número de ouvintes chamados a participar no inicio de cada edição de jogo é definido no inicio de jogo. No minimo\n" +
                "participam 2 ouvintes, no máximo 5.\n" +
                "É importante salientar que para haver um novo jogo terão de existir pelo menos 2 ouvintes a dar palpites e pelo menos 5\n" +
                "ouvintes na base de dados. Os ouvintes são chamados a participar pela ordem que são selecionados sendo que cada ouvinte\n" +
                "só pode ser selecionado uma vez por jogo, ou seja, o mesmo ouvinte não pode ser selecionado mais que uma vez por jogo\n" +
                "para dar palpites");
        System.out.println("------------------------------------------------------------------------------------------------------------------------");
        System.out.println("                                                    Tipo de jogo");
        System.out.println("------------------------------------------------------------------------------------------------------------------------");
        System.out.println("Existem dois tipo de jogo:\n--------------------------\nJogo simulado: ao optar por este modo, os ouvintes dão palpites aleatórios dentro" +
                " do minimo e máximo válidos para cada jogo.\n--------------------------\n" +
                "Jogo em que o utilizador insere os dados pelos participantes: é sorteado o número de participantes (entre 2 e 5 por jogo).\n" +
                "Os ouvintes são chamados a participar pela ordem que são selecionados sendo que o utilizador pode definir o valor do\n" +
                "palpite de cada ouvinte dentro dos limites minimo e máximo.");
        System.out.println("------------------------------------------------------------------------------------------------------------------------");
        System.out.println("                                               Condições de Vitória");
        System.out.println("------------------------------------------------------------------------------------------------------------------------");
        System.out.println("O ouvinte que der o valor certo ganha. Se nenhum dos ouvintes acertar no valor correcto, o vencedor é o ouvinte que apostou\n" +
                "o valor mais próximo do peso exacto que é anunciado no inicio de cada jogo.");
        System.out.println("------------------------------------------------------------------------------------------------------------------------");
        System.out.println("                                            Condições em caso de empate");
        System.out.println("------------------------------------------------------------------------------------------------------------------------");
        System.out.println("Só pode haver um vencedor. Em caso de empate, o vencedor é o primeiro jogador a dar o palpite. Por exemplo, o peso certo\n" +
                "é 1.100kg. O José deu o palpite de 1.075kg e a Maria 1.125Kg. Apesar de ambos ficarem a 25g do peso correcto, como o José\n" +
                "foi o primeiro ouvinte a ser selecionado para participar, é o vencedor. Ou seja, a ordem pela qual os ouvintes são chamados\n" +
                "a participarserve como factor de desempate.");
        System.out.println("------------------------------------------------------------------------------------------------------------------------");
        System.out.println("                                                    Ranking");
        System.out.println("------------------------------------------------------------------------------------------------------------------------");
        System.out.println("Na lista de Ranking aparecem todos os ouvintes com pelo menos uma vitória no jogo. Os ouvintes estão classificados pelo\n" +
                "maior número de vitórias. No caso de os ouvintes possuirem o mesmo número de vitórias, o melhor classificado será o ouvinte\n" +
                "com melhor ratio entre número de vitórias e participações. Um ouvinte com menos participações tem melhor ratio que outro\n" +
                "ouvinte com o mesmo número de vitórias.\n" +
                "Caso existam ouvintes com empate técnico (isto é, com o mesmo ratio: mesmo número de vitórias e mesmo número de participações)\n" +
                "entra outro factor de desempate, a vitória por edição. Um ouvinte que ganhe uma edição prévia, fica classificado sobre\n" +
                "outro ouvinte que chegue às mesmas vitórias e ao mesmo número de participações posteriormente.");
        System.out.println("------------------------------------------------------------------------------------------------------------------------");
        System.out.println("                                                    Ouvintes");
        System.out.println("------------------------------------------------------------------------------------------------------------------------");
        System.out.println("O programa inicia já com alguns ouvintes adicionados na base de dados.\n" +
                "O utilizador pode criar, editar (campos Nome, Telefone, Idade e Localidade) e eliminar os ouvintes que desejar.\n" +
                "É também permitido ao utilizador consultar a lista de ouvintes na base de dados e consultar um ouvinte especifico por ID.\n" +
                "Ao criar um ouvinte ele é adicionado à base de dados e fica automáticamente disponivel para ser sorteado e ir a jogo na\n" +
                "próxima edição do concurso. Nota que ao eliminar um ouvinte, ele é removido da base de dados e do ranking.");
        System.out.println("========================================================================================================================");
    }
    ...
    private static void JogoSimulacao() {
        if (listaOuvintes.size() > 4) {
            ...
            for (int i = 0; i < ouvintesAJogo; i++) {
                ...
                if (!listaOuvintesAJogo.contains(ouvintesTemp)) {
...
//------------------------------------------------------ OUVINTE -----------------------------------------------------//
    private static void EliminarOuvinte() {
        if (listaOuvintes.size() > 0) {
            ...
            /*    if (listaOuvintes.isEmpty()) { // alternativa ao if listaOuvintes.size() > 0.
...
//----------------------------------------------- BASE DE DADOS OUVINTE ----------------------------------------------//
    private static void Init() {
        ...
        listaOuvintes.add(new Ouvinte(10, "Pedro Sousa", 295512345, 64, "Caminha", 0, 0, 0));        //9
